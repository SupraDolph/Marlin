...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 250, 250, 200, 100 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 600, 600, 400, 9000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25.4, -30.3, -1.65 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { X_MIN_POS + 5, Y_MIN_POS + 10, 20 } // X Only
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_IDLE_SLEEP_MINS 30  // (minutes) Display Sleep after a period of inactivity. Set with M255 S.
